# RealTimeX Marketplace Listing: RealTimeX Alchemy

## Metadata
- **Display Name**: RealTimeX Alchemy
- **Short Description**: A private, passive intelligence engine that transforms your browsing history into a searchable, structured knowledge base.
- **Tags**: Productivity, AI, Knowledge Management, Privacy, RealTimeX
...
### 🛡️ Privacy-First: Own Your Database
Alchemy follows the **"Own Your Database"** philosophy. All your mined signals, embeddings, and chat history are stored in **your own Supabase instance**. RealTimeX never sees your data.

### 🔌 RealTimeX Desktop Integration
Designed to run as a **Local App**, Alchemy leverages the global AI providers (OpenAI, Anthropic, Ollama, etc.) configured in your **RealTimeX Desktop** environment. No messy API key management within the app—it just works.

---

## Visual Assets
- **Square Cover**: `docs/images/cover.png`
- **Landscape Cover**: `docs/images/cover-landscape.png`
